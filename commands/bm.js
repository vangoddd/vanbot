...
module.exports = {
	...
	execute(message, args) {
        ...
        .then(response => {
            ...
            const thumbnail = 'https://b.ppy.sh/thumb/'.concat(apiData.beatmapSetId).concat('.jpg');
            ...
            .addField('Info', 'Difficulty : '.concat(apiData.diff).concat(' ['.concat(apiData.star).concat(']')
            .concat('\nMapper : ').concat(apiData.author)), true)
            .setTimestamp()
